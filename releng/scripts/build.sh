...
if [[ $profiles == *"publish"* ]]; then
	if curl --output /dev/null --silent --head --fail --user $ArtifactStoreUserName:$ArtifactStorePassword "https://nexus-p2.manatree.io/nexus/content/sites/MDEAssets/espilce-commons/$updateSite/content.jar"; then
