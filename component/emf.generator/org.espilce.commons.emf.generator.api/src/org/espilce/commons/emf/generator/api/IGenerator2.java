...
public interface IGenerator2 {
	 ...
	 * are blocking.
	 */
	void doGenerate(final @NonNull Resource input, final @NonNull IFileSystemAccess2 fsa,
	 ...
	 * is executed.
	 */
	void beforeGenerate(final @NonNull Resource input, final @NonNull IFileSystemAccess2 fsa,
			final @NonNull IGeneratorContext context);
	 ...
	 */
	void afterGenerate(final @NonNull Resource input, final @NonNull IFileSystemAccess2 fsa,
			final @NonNull IGeneratorContext context);
