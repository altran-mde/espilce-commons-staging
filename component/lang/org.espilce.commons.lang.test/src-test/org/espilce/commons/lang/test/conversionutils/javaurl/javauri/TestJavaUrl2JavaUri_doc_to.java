...
public class TestJavaUrl2JavaUri_doc_to {
	@Test
	public void empty() throws Exception {
		final URI expected = new URI(null, null, null);
		final URI actual = ConversionUtils.toJavaUri(new URL("file:"));
	...
	public void schemeStartDoubleDot() throws Exception {
		...
		final URI actual = ConversionUtils.toJavaUri(new URL("file:../some/path/."));
		assertEquals(expected, actual);
	}
	...
	public void slashAbsolute() throws Exception {
		...
		final URI actual = ConversionUtils.toJavaUri(new URL("file:/some/path/MyFile.ext"));
		assertEquals(expected, actual);
	}
	...
	public void driveAbsolute() throws Exception {
		...
		final URI actual = ConversionUtils.toJavaUri(new URL("file:/c:/some/path/MyFile.ext"));
		assertEquals(expected, actual);
	}
	...
	public void encodedQuery() throws Exception {
		...
		final URI actual = ConversionUtils.toJavaUri(new URL("file:/myProject/myFolder%23query"));
		assertEquals(expected, actual);
	}
	...
	public void queryFragment() throws Exception {
		...
		final URI actual = ConversionUtils.toJavaUri(new URL("file:/myProject/myFolder?query#fragment"));
		assertEquals(expected, actual);
	}
	...
	public void web() throws Exception {
		...
		final URI actual = ConversionUtils.toJavaUri(new URL("http://example.com"));
		assertEquals(expected, actual);
	}
	...
	public void mail() throws Exception {
		...
		final URI actual = ConversionUtils.toJavaUri(new URL("mailto:test@example.com"));
		assertEquals(expected, actual);
	}
