...
public class TestJavaPath2JavaUri_As {
	@SuppressWarnings("null")
	@Test(expected = NullPointerException.class)
	public void fileNull() throws Exception {
		ConversionUtils.asJavaUri((Path) null);
	}
	...
	public void empty() throws Exception {
		...
		assertEquals(javaUri, ConversionUtils.asJavaUri(path));
	}
	
	@Test
	public void absoluteNestedFile() throws Exception {
		final Path path = Paths.get("//some/path/MyFile.ext");
		final URI javaUri = ConversionUtils.asJavaUri(path);
