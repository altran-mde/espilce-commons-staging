...
public class TestJavaFile2JavaUrl_doc_to {
	@Test
	public void empty() throws Exception {
		final URL expected = new URL("file:");
		final URL actual = ConversionUtils.toJavaUrl(new File(""));
	...
	public void file() throws Exception {
		...
		final URL actual = ConversionUtils.toJavaUrl(new File("MyFile.ext"));
		assertEquals(expected, actual);
	}
	...
	public void relative() throws Exception {
		...
		final URL actual = ConversionUtils.toJavaUrl(new File("some/path/MyFile.ext"));
		assertEquals(expected, actual);
	}
	...
	public void startDoubleDot() throws Exception {
		...
		final URL actual = ConversionUtils.toJavaUrl(new File("../some/path/."));
		assertEquals(expected, actual);
	}
	...
	public void encodedQuery() throws Exception {
		...
		final URL actual = ConversionUtils.toJavaUrl(new File("myProject/myFolder%23query"));
		assertEquals(expected, actual);
	}
	
	@Test
	public void nullParam() throws Exception {
		assertNull(ConversionUtils.toJavaUrl((File) null));
	}
	
	@Test
	public void queryFragment() throws Exception {
		final URL expected = new URL("file:myProject/myFolder%3Fquery%23fragment");
		final URL actual = ConversionUtils.toJavaUrl(new File("myProject/myFolder?query#fragment"));
		assertEquals(expected, actual);
	}
	...
	public void slashDrive() throws Exception {
		...
		final URL actual = ConversionUtils.toJavaUrl(new File("/c:/some/path/MyFile.ext"));
		assertEquals(expected, actual);
	}
