...
public class TestJavaFile2JavaUri_doc_to {
	@Test
	public void empty() throws Exception {
		final URI expected = new URI("");
		final URI actual = ConversionUtils.toJavaUri(new File(""));
	...
	public void file() throws Exception {
		...
		final URI actual = ConversionUtils.toJavaUri(new File("MyFile.ext"));
		assertEquals(expected, actual);
	}
	...
	public void relative() throws Exception {
		...
		final URI actual = ConversionUtils.toJavaUri(new File("some/path/MyFile.ext"));
		assertEquals(expected, actual);
	}
	...
	public void startDoubleDot() throws Exception {
		...
		final URI actual = ConversionUtils.toJavaUri(new File("../some/path/."));
		assertEquals(expected, actual);
	}
	...
	public void encodedQuery() throws Exception {
		...
		final URI actual = ConversionUtils.toJavaUri(new File("myProject/myFolder%23query"));
		assertEquals(expected, actual);
	}
	...
	public void queryFragment() throws Exception {
		...
		final URI actual = ConversionUtils.toJavaUri(new File("myProject/myFolder?query#fragment"));
		assertEquals(expected, actual);
	}
	...
	public void slashDrive() throws Exception {
		...
		final URI actual = ConversionUtils.toJavaUri(new File("/c:/some/path/MyFile.ext"));
		assertEquals(expected, actual);
	}
