...
public class TestJavaPath2JavaFile_doc_as {
	@Test
	public void empty() throws Exception {
		final File expected = new File("");
		final File actual = ConversionUtils.asJavaFile(Paths.get(""));
	...
	public void file() throws Exception {
		...
		final File actual = ConversionUtils.asJavaFile(Paths.get("MyFile.ext"));
		assertEquals(expected, actual);
	}
	...
	public void relative() throws Exception {
		...
		final File actual = ConversionUtils.asJavaFile(Paths.get("some/path/MyFile.ext"));
		assertEquals(expected, actual);
	}
	...
	public void startDoubleDot() throws Exception {
		...
		final File actual = ConversionUtils.asJavaFile(Paths.get("../some/path/."));
		assertEquals(expected, actual);
	}
	...
	public void encodedQuery() throws Exception {
		...
		final File actual = ConversionUtils.asJavaFile(Paths.get("/myProject/myFolder%23query"));
		assertEquals(expected, actual);
	}
	...
	public void drive() throws Exception {
		...
		final File actual = ConversionUtils.asJavaFile(Paths.get("c:/some/path/MyFile.ext"));
		assertEquals(expected, actual);
	}
	...
	public void nullParam() throws Exception {
		assertThrows(NullPointerException.class, () -> ConversionUtils.asJavaFile((Path) null));
	}
	...
	public void queryFragment_unix() throws Exception {
		...
		final File actual = ConversionUtils.asJavaFile(Paths.get("/myProject/myFolder?query#fragment"));
		assertEquals(expected, actual);
	}
