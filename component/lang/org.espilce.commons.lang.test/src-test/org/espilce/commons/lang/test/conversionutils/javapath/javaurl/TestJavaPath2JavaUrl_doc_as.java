...
public class TestJavaPath2JavaUrl_doc_as {
	@Test
	public void empty() throws Exception {
		final URL expected = new URL("file:");
		final URL actual = ConversionUtils.asJavaUrl(Paths.get(""));
	...
	public void file() throws Exception {
		...
		final URL actual = ConversionUtils.asJavaUrl(Paths.get("MyFile.ext"));
		assertEquals(expected, actual);
	}
	...
	public void relative() throws Exception {
		...
		final URL actual = ConversionUtils.asJavaUrl(Paths.get("some/path/MyFile.ext"));
		assertEquals(expected, actual);
	}
	...
	public void startDoubleDot() throws Exception {
		...
		final URL actual = ConversionUtils.asJavaUrl(Paths.get("../some/path/."));
		assertEquals(expected, actual);
	}
	...
	public void encodedQuery() throws Exception {
		...
		final URL actual = ConversionUtils.asJavaUrl(Paths.get("myProject/myFolder%23query"));
		assertEquals(expected, actual);
	}
	...
	public void nullParam() throws Exception {
		assertThrows(NullPointerException.class, () -> ConversionUtils.asJavaUrl((Path) null));
	}
	...
	public void queryFragment_unix() throws Exception {
		...
		final URL actual = ConversionUtils.asJavaUrl(Paths.get("myProject/myFolder?query#fragment"));
		assertEquals(expected, actual);
	}
	...
	public void slashDrive_unix() throws Exception {
		...
		final URL actual = ConversionUtils.asJavaUrl(Paths.get("/c:/some/path/MyFile.ext"));
		assertEquals(expected, actual);
	}
