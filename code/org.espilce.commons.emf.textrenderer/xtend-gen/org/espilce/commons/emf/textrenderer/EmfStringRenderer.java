...
public class EmfStringRenderer {
  ...
  protected <T extends Object> void renderCollection(final Collection<T> collection, final int indent, final EObject context, final Consumer<T> lineRenderer) {
    this.builder.append("[");
  ...
  protected void _render(final EObject eObject, final int indent, final EObject context) {
    ...
    List<EStructuralFeature> _sortBy = IterableExtensions.<EStructuralFeature, String>sortBy(eObject.eClass().getEAllStructuralFeatures(), _function);
  ...
  protected void renderAttribute(final EAttribute attribute, final int indent, final EObject context, final Object value) {
  ...
  protected void renderReference(final EReference reference, final int indent, final EObject context, final EObject target) {
    if ((target != null)) {
  ...
  protected void render(final Object attribute, final int indent, final EObject context) {
    if (attribute instanceof EAttribute) {
      ...
      throw new IllegalArgumentException("Unhandled parameter types: " +
        Arrays.<Object>asList(attribute, indent, context).toString());
    }
  }
}
